...
namespace Akila.FPSFramework
{
    ...
    public class ExplosiveEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            explosive.deathRadius = EditorGUILayout.FloatField("Radius", explosive.deathRadius);
            explosive.damageRadius = EditorGUILayout.FloatField("Effect Radius", explosive.damageRadius);
