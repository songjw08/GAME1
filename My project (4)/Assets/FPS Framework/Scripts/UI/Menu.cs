...
namespace Akila.FPSFramework.UI
{
    ...
    public class Menu : MonoBehaviour
    {
        ...
        protected virtual void Update()
        {
            if (CanvasGroup != null)
            {
                CanvasGroup.alpha = Mathf.SmoothDamp(CanvasGroup.alpha, TargetAlpha, ref _alphaChangeVelocity, transitionTime);
        ...
        public void OpenMenu()
        {
            if (MenusManager == null)
            {
                Debug.LogError("MenusManager is not assigned. Ensure the parent object has a MenusManager component.", gameObject);
