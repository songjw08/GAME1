    ...
    public class Tab : MonoBehaviour, IPointerEnterHandler, IPointerDownHandler, IPointerExitHandler
    {
        ...
        private void InitializeGraphics()
        {
            if (tabImage == null)
            {
                ...
                tabImage = transform.SearchFor<Image>();
        ...
        private void InitializeText()
        {
            if (tabText == null)
            {
                ...
                tabText = transform.SearchFor<TextMeshProUGUI>();
        ...
        private void Update()
        {
            ...
            currentImageColor = Color.Lerp(currentImageColor, targetImageColor, colorTransitionSpeed * Time.deltaTime);
            currentTextColor = Color.Lerp(currentTextColor, targetTextColor, colorTransitionSpeed * Time.deltaTime);
